...
public class SignupActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG2 = SignupActivity.class.getSimpleName();
    ...
    int numChar, numberM;
    String accountID, LastID, name = "", email = "", subject = "Cash On Wise Send you a ID Accouunt", content = "", accountIDShow = "";
    ...
    public void successfulSignUp(){
        ...
        accountIDShow = incrementAccountID;
/*
        try{ // Code for email
            ...
            pDialog.setMessage("Sending your ID to " + email);
            //pDialog.show();
        ...
        */
        Toast.makeText(getApplicationContext(), "Your ID is: " + incrementAccountID, Toast.LENGTH_LONG).show();
        finish();
    }
    ...
    private class RetrieveFeedTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            content = "Dear Mr./Ms. " + name + ", </br></br>Your ID is : <b>" + accountIDShow + "</b>.</br></br>Best regards,</br>Teddy Chow</br>Senior Officer</br>Cash On Wise";
            try {
                ...
                Toast.makeText(getApplicationContext(),
                        "ID successful send to your email.",
                        Toast.LENGTH_SHORT).show();
            }catch (MessagingException ex){
                Log.d(TAG2, "Messaging Error: " + ex.getMessage());
            }catch (Exception ex){
                ex.printStackTrace();
            }
            return null;
        ...
        protected void onPostExecute(String result) {
            //pDialog.dismiss();
            Toast.makeText(getApplicationContext(), "ID sent", Toast.LENGTH_SHORT).show();
        }
    }
